...
export const History: React.FC = () => {
  ...
  const advanceStatus = () => {
    ...
    const map: Record<
      string,
      'Assigned' | 'En Route' | 'Completed' | 'Searching'
    > = {
      Searching: 'Assigned',
      Assigned: 'En Route',
      'En Route': 'Completed',
  ...
  const stepIndex =
    {Searching: 0, Assigned: 1, 'En Route': 2, Completed: 3}[requestStatus] ??
    0;
                        ...
                        <View
                          ...
                          {done ? (
                            ...
                            <Circle
                              size={8}
                              color={
                                active ? statusColor : 'rgba(255,255,255,0.15)'
                              }
                              fill={active ? statusColor : 'transparent'}
                              strokeWidth={2}
                            />
                          )}
                        </View>
                ...
                {requestStatus === 'Searching' ? (
                  <View style={styles.searchingBox}>
                    ...
                    <Text style={styles.searchingText}>
                      Locating nearby mechanics & workshops…
                    </Text>
                  </View>
                ) : (
                  <View style={styles.assignedRow}>
                    ...
                    <View style={{flex: 1}}>
                      ...
                      <View style={styles.mechanicMeta}>
                        ...
                        <Text style={styles.mechanicSpec}>
                          Toyota Specialist
                        </Text>
                      </View>
                    </View>
            ...
            <View style={styles.safetyCard}>
              ...
              <View style={{flex: 1}}>
                ...
                <Text style={styles.safetyBody}>
                  In case of delays, the system auto-sends SMS alerts to your
                ...
                <TouchableOpacity
                  ...
                  <View style={styles.pastCardTop}>
                    <View style={styles.pastTypeRow}>
                      <View
                        style={[styles.pastTypeIcon, {backgroundColor: bg}]}>
                        <Icon size={18} color={color} strokeWidth={2} />
                      </View>
                      <View>
                        <Text style={styles.pastTypeName}>
                          {req.type} Service
                        </Text>
                  ...
                  <View style={styles.pastCardBody}>
                    ...
                    <View style={styles.pastRow}>
                      ...
                      <Text style={[styles.pastVal, styles.costVal]}>
                        {req.cost}
                      </Text>
                    </View>
                  </View>
                ...
                return (
                  <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={ms.reqBanner}>
                      ...
                      <View style={{flex: 1}}>
                        <Text style={ms.reqType}>
                          {selectedRequest.type} Service
                        </Text>
                        <Text style={ms.reqProvider}>
